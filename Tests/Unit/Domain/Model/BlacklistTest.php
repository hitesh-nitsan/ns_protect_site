...
/**
 * Test case for class \NS\NsProtectSite\Domain\Model\Blacklist.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class BlacklistTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \NS\NsProtectSite\Domain\Model\Blacklist
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \NS\NsProtectSite\Domain\Model\Blacklist();
	}
